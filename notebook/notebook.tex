...
\newcommand{\team}{\quad University: \textbf{Universidad Nacional de La Matanza, DIIT} \quad\quad Team: \textbf{}
...
\codefile{basicos/lower_bound.py}
\codefile{basicos/upper_bound.py}

\subsection{Tabla Aditiva}
\codefile{basicos/tabla_aditiva.py}
\codefile{basicos/tabla_aditiva_2D.py}

\subsection{Programación Dinámica}
\codefile{basicos/sub_set_sum.py}
\codefile{basicos/cambio_monedas.py}

\subsection {Recurrencias Lineales}
\codefile{basicos/recurrenci_lineal.py}

\subsection{Heap y Heapsort}
\codefile{basicos/heapsort.py}
\codefile{basicos/max_heap.py}
